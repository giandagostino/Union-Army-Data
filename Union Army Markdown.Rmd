...
duckdb::duckdb_register(con, "mil", mil)
duckdb::duckdb_register(con, "dis", dis)
duckdb::duckdb_register(con, "msr", msr)
duckdb::duckdb_register(con, "cen", cen)
duckdb::duckdb_register(con, "cmr", cmr)
...
duckdb::duckdb_register(con, "full_data1", full_data1)
duckdb::duckdb_register(con, "full_data2", full_data2)
...
duckdb::duckdb_register(con, "tb", tb)
...
tb_lst <- sapply(as.data.frame(tb_lst)
...
nx1_1 <- as.numeric(substr(ntb_birth$lstdt1_1, 1, 4)) - ntb_birth$lstag1_1
nx1_2 <- as.numeric(substr(ntb_birth$lstdt1_2, 1, 4)) - ntb_birth$lstag1_2
nx1_3 <- as.numeric(substr(ntb_birth$lstdt1_3, 1, 4)) - ntb_birth$lstag1_3
nx2_1 <- as.numeric(substr(ntb_birth$lstdt2_1, 1, 4)) - ntb_birth$lstag2_1
nx2_2 <- as.numeric(substr(ntb_birth$lstdt2_2, 1, 4)) - ntb_birth$lstag2_2
nx2_3 <- as.numeric(substr(ntb_birth$lstdt2_3, 1, 4)) - ntb_birth$lstag2_3

ntb_lst <- cbind(nx1_1, nx1_2, nx1_3, nx2_1, nx2_2, nx2_3)
ntb_lst <- sapply(as.data.frame(ntb_lst)
